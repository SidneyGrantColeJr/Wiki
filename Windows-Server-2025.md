...
3.	In the iSCI Virtual Disks pane, select Tasks, and then select New iSCSI Virtual Disk.
...
5.	On the Specify iSCSI Virtual Disk Name page, in the Name text box, enter iSCSI Disk1 and then select Next.
6.	On the Specify iSCSI virtual disk page, in the Size text box, enter 5.  Ensure that GB is selected and then select Next.
7.	On the Assign iSCSI Target page, ensure that the New iSCSI Target option is selected and then select Next.
8.	On the Specify target name page, in the Name text box, enter your Server Name and the select Next.
...
11.	In the Value text box enter 192.168.4.194 (Target’s IP) and then select ok.
12.	On the Specify access servers page, select Next.
13.	On the Enable Authentication page, select Next.
14.	On the Confirm Selections page, select Create.
15.	On the View Results page, wait until the Virtual disk is created, and then select Close.
16.	In the iSCSI Virtual Disks pane, select Tasks and then select New iSCSI Virtual Disk.
17.	In the New iSCSI Virtual Disk Wizard, on the Select iSCSI Virtual Disk Location page, under Storage location, select volume C: and then select Next.
18.	On the Specify iSCSI Virtual Disk Name page, in the Name text box, enter iSCSIDisk2 and then select Next.
19.	On the Specify iSCSI virtual disk size page in the Size text box, enter 5.  Ensure GB is selected and then select Next.
20.	On the Assign iSCSI Target page, select cole-svr2 and then select Next.
21.	On the Confirm selections page, select Create.
22.	On the View results page, wait until the virtual disk is created and then select Close.
